programa{ 
  ...
  ///atualizar jogador
	...
	//Ganhou por coluna?
	funcao inteiro ganhouPorColuna(caracter f){//Mateus status: ok
			para(c = 0; c < 3; c++)
			{
	...
	funcao inteiro ganhouDPrincipal(caracter d){//Savio Status = ok
	...
	funcao inteiro ganhouDSecundaria(caracter p){//Savio Status = ok
